...
const invokeTransaction = async (channelName, chaincodeName, fcn, args, username, org_name, transientData) => {
    try {
        ...
        // const ccpPath =path.resolve(__dirname, '..', 'config', 'connection-FF.json');
        ...
        let result
        let message;
        if (fcn === "createCar" || fcn === "createPrivateCarImplicitForFF"
            || fcn == "createPrivateCarImplicitForClemson") {
