...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	case "createPrivateCarImplicitForFF":
		return s.createPrivateCarImplicitForFF(APIstub, args)
	case "createPrivateCarImplicitForClemson":
		return s.createPrivateCarImplicitForClemson(APIstub, args)
...
func (s *SmartContract) readPrivateCar(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	// collectionCars, collectionCarPrivateDetails, _implicit_org_FFMSP, _implicit_org_ClemsonMSP
...
func (s *SmartContract) readPrivateCarIMpleciteForFF(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {

	if len(args) != 1 {
		return shim.Error("Incorrect number of arguments. Expecting 1")
	}

	carAsBytes, _ := APIstub.GetPrivateData("_implicit_org_FFMSP", args[0])
	return shim.Success(carAsBytes)
}
...
func (s *SmartContract) createPrivateCarImplicitForFF(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	err := APIstub.PutPrivateData("_implicit_org_FFMSP", args[0], carAsBytes)
	if err != nil {
...
func (s *SmartContract) createPrivateCarImplicitForClemson(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	err := APIstub.PutPrivateData("_implicit_org_ClemsonMSP", args[0], carAsBytes)
	if err != nil {
		return shim.Error("Failed to add asset: " + args[0])
	}
	return shim.Success(carAsBytes)
